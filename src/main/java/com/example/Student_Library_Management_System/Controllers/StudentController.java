...
//    }
    ...
    @PutMapping("/update_mobileNo")
    public String updateMobileNumber(@RequestBody StudentUpdateMobileRequestDto studentUpdateMobileRequestDto)
    {
        return studentService.updateMobileNumber(studentUpdateMobileRequestDto);
    }
}
